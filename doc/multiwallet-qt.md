...
In order to support loading of multiple wallets in dod-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dod.cpp.
...
Changes to dod.cpp
----------------------
dod.cpp is the entry point into dod-qt, and as such, will require some minor modifications to provide hooks for
