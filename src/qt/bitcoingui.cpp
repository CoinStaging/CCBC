...
spinnerFrame(0)
{
	...
	QString windowTitle = tr("DOD Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a DOD address"));
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DOD Core"), this);
	aboutAction->setStatusTip(tr("Show information about DOD Core"));
	...
	optionsAction->setStatusTip(tr("Modify configuration options for DOD"));
	...
	signMessageAction->setStatusTip(tr("Sign messages with your DOD addresses to prove you own them"));
	verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
	verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DOD addresses"));
	...
	openAction->setStatusTip(tr("Open a DOD: URI or payment request"));
	openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
	openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

	showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
	showHelpMessageAction->setMenuRole(QAction::NoRole);
	showHelpMessageAction->setStatusTip(tr("Show the DOD Core help message to get a list with possible DOD command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("DOD Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DOD network", "", count));
}
...
{
	QString strTitle = tr("DOD Core"); // default title
