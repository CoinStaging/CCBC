                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Dod from zDod"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDod"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDod));
