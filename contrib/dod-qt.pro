...
RESOURCES += src/qt/dod.qrc src/qt/dod_locale.qrc

TRANSLATIONS += src/qt/locale/dod_bg.ts \
                src/qt/locale/dod_de.ts \
                src/qt/locale/dod_en.ts \
                src/qt/locale/dod_es.ts \
                src/qt/locale/dod_fi.ts \
                src/qt/locale/dod_fr.ts \
                src/qt/locale/dod_it.ts \
                src/qt/locale/dod_ja.ts \
                src/qt/locale/dod_pl.ts \
                src/qt/locale/dod_pt.ts \
                src/qt/locale/dod_ru.ts \
                src/qt/locale/dod_sk.ts \
                src/qt/locale/dod_sv.ts \
                src/qt/locale/dod_vi.ts \
                src/qt/locale/dod_zh_CN.ts \
                src/qt/locale/dod_zh_TW.ts
