Contributing to Dod Core
============================

The Dod Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dod Core project, and is not to be
confused with overall Dod Network Protocol consensus changes.

Whether a pull request is merged into Dod Core rests with the project merge
...
Patches that change Dod consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dod consensus, it must have been
...
The project leader is the release manager for each Dod Core release.
